...
\begin{center}
  \vspace*{\fill}
  \textsc{\Huge Probabilidad y Estad\'istica\\[2ex] \huge Conceptos y Formulario }
  \vfill
  \footnotesize{
    Version \version\\[1ex]
    \today\\[1ex]
...
\begin{multicols*}{3}
  ...
  \hrule
  \vspace{5pt}
  {\footnotesize Este formulario de conceptos básicos integra varios temas sobre teoría de la probabilidad y estadística, basado en... literature~\cite{Hoel72,Wasserman03,Shumway06} y en el material de clase de diversos cursos de probabilidad y estadística en diversos grados de la Universidad de Córdoba but also influenced by others \cite{Steger01,Steger02}. If you find errors or have suggestions for improvements, please get in touch at \web.}
\end{multicols*}

\newpage

\section{Distribuciones de Probabilidad: Perspectiva General}

\subsection{Distributiones Discretas}
